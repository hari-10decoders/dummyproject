...
public class ninja_stepdef {
	...
	public void i_enter_the_all_mandatory_personal_details_data_such_as_pass_word_and_pass_word_confirm() {
		driver.findElement(By.name("password")).sendKeys("Avengers@2023");
		driver.findElement(By.name("confirm")).sendKeys("Avengers@2023");
	}
	@When("I click the radio in subscribe fields as yes and click the chec_kbox in privacy policy fields1")
	public void i_click_the_radio_in_subscribe_fields_as_yes_and_click_the_chec_kbox_in_privacy_policy_fields1() {
		driver.findElement(By.name("newsletter")).click();
		driver.findElement(By.name("agree")).click();
	}
	...
	public void i_click_the_continue_button_and_user_should_not_able_to_logged_in_insetead_of_showing_message_warning_e_mail_address_is_already_registered() {
		driver.findElement(By.xpath("//input[@value='Continue']")).click();
